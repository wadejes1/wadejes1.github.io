...
A pretty low average across the U.S. at only 81.376 in the month of April 2023. Very strong left skew towards the bottom
...
knitr::kable(
 County_top_20,caption = "Top 20 Multifamily Permits in April 2023 by number of Units, County Level"
)
```
...
knitr::kable(
  State_Counts %>% 
    top_n(10,MultifamilyPermits),caption = "Top 10 Multifamily Permits in April 2023, Statewise"
)
```
